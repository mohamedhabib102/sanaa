        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          ...
          >
            <div className="aspect-4/5 overflow-hidden rounded-3xl shadow-xl">
              <img src="/imgs/profile_3.jpeg" alt="إتقان العمل في لمسة ديكور" className="w-full h-full object-cover" />
            </div>
          ...
          >
            ...
            <p className="text-zinc-500 text-lg leading-relaxed mb-12">
              نحن في "لمسة ديكور" نؤمن بأن كل جدار وسقف هو فرصة للإبداع. نتخصص في تنفيذ أرقى الديكورات المعمارية باستخدام أفضل الخامات العالمية. فريقنا يجمع بين الفن والهندسة لتنفيذ أعمال الجبسوم بورد، والأسقف المعلقة، وواجهات الـ GRC والـ GRB التي تمنح الفيلات والقصور هيبتها وفخامتها.
            </p>
